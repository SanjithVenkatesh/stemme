...
def mmp(party_vote: Dict[Party, int], parties: List[str], seats: int, constituency_votes):
    winners: List[str] = []
    ...
    highest_remainders = sorted(remainder, key = remainder.get, reverse=True)[:remaining_seats]
